...
%macro EasyRun(Scenario,IncubationPeriod,InitRecovered,RecoveryDays,ISOChangeDate,SocialDistancingChange,doublingtime,Population,KnownAdmits,KnownCOVID,SocialDistancing,MarketSharePercent,Admission_Rate,ICUPercent,VentPErcent,FatalityRate);
...
data work. &Scenario; set work.DS_SIR_3;
...
;
PROC APPEND base=store.MODEL_FINAL data=work. &Scenario NOWARN FORCE; run;

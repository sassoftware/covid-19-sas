...
/*					ModelType="SEIR with PROC (T)MODEL-Fit R0";*/
					ModelType="SEIR with PROC (T)MODEL-Smooth";
X_IMPORT: keys.sas
				run;
				DATA FIT_PARMS;
					SET FIT_PARMS;
...
/*				WHERE _TYPE_  NE 'RESIDUAL' and ModelType='SEIR with PROC (T)MODEL-Fit R0' and ScenarioIndex=&ScenarioIndex.;*/
				WHERE _TYPE_  NE 'RESIDUAL' and ModelType='SEIR with PROC (T)MODEL-Smooth' and ScenarioIndex=&ScenarioIndex.;
...
/*				where ModelType='SEIR with PROC (T)MODEL-Fit R0' and ScenarioIndex=&ScenarioIndex.;*/
				where ModelType='SEIR with PROC (T)MODEL-Smooth' and ScenarioIndex=&ScenarioIndex.;
